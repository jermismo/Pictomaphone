...
{
    public class BoxBlur : EffectBase
    {

        public const string Name = "BoxBlur";
        ...
        {
            if (currentPass == 0) pixel = HorizontalPass((ColorB)pixel, x, y);
            if (currentPass == 1) pixel = VerticalPass((ColorB)pixel, x, y);
            return pixel;
        }
